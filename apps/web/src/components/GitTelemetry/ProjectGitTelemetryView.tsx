  ...
  if (isLoading) {
    return (
      <div className="p-12 text-center font-mono space-y-3">
        <RefreshCw className="w-6 h-6 animate-spin text-[#B497CF] mx-auto" />
      ...
      <div className="p-5 bg-[#0d0d0d] border border-border rounded-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="w-2.5 h-2.5 bg-[#B497CF] animate-pulse rounded-xs" />
            <span className="text-[10px] text-[#B497CF] font-bold tracking-widest uppercase">
          ...
          <h2 className="text-base font-black text-foreground uppercase tracking-wide mt-1 flex items-center gap-2">
            ...
            >
              ...
              <ExternalLink className="w-3 h-3 text-[#B497CF]" />
            </a>
          </h2>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Zap className="w-3.5 h-3.5 text-[#B497CF]" />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="p-4 bg-[#0d0d0d] border border-border rounded-sm">
          <div className="flex items-center justify-between text-muted-foreground mb-1">
            ...
            <GitCommitIcon className="w-4 h-4 text-[#B497CF]" />
          </div>
      ...
      <section aria-label="Collaborators Live Pulse" className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2">
            <Users className="w-4 h-4 text-[#B497CF]" />
            ...
            return (
              <div
                ...
                className={`p-4 bg-[#0d0d0d] border transition-all rounded-sm cursor-pointer ${
                  isSelected ? 'border-[#B497CF] ring-1 ring-[#B497CF] bg-[#140c06]' : 'border-border hover:border-foreground'
                }`}
              >
                ...
                <div className="pt-2 border-t border-border/60 space-y-1.5">
                  ...
                  <div className="flex items-center justify-between text-[9px] text-muted-foreground uppercase">
                    ...
                    <span className="text-[#B497CF] font-bold">{collab.active_branch}</span>
                  </div>
                </div>
              </div>
            );
          ...
          <div className="flex items-center gap-2">
            ...
            {authorFilter !== 'all' && (
              <button
                ...
                className="px-2 py-1 bg-[#B497CF] text-background text-[10px] font-bold uppercase rounded-xs"
              >
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-bold text-foreground group-hover:text-[#B497CF] transition-colors">
                        {commit.message}
                      </span>
                    </div>
            ...
            >
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-xs font-bold text-foreground flex items-center gap-1.5">
                  <GitBranch className="w-3.5 h-3.5 text-[#B497CF]" />
                  <span>{br.name}</span>
                </span>
                {br.is_sleeper ? (
          ...
          <div className="w-full max-w-lg bg-[#0d0d0d] border-2 border-foreground p-6 shadow-2xl space-y-4 text-foreground">
            <div className="flex items-center justify-between border-b border-border pb-3">
              <span className="text-xs font-bold uppercase text-foreground flex items-center gap-2">
                <Zap className="w-4 h-4 text-[#B497CF]" />
