...
export function getSecurityFilterSQL(user: User | undefined, tableAlias: string = 'bugs'): { sql: string; params: any[] } {
...
export function requireBugAccess(paramName: string = 'id') {
